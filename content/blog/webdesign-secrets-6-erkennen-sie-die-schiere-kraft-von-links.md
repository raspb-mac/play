...
Sie sollten alle (Unter-)Seiten auf und um Ihre gewählten Keywords optimieren (Wie man die richtigen Keywords wählt, werden wir in einem späteren Teil dieser Serie klären). Das heißt: gut strukturierte Inhalte mit Substanz anbieten, die einen Mehrwert für den Suchenden bieten und von Google als solche erkannt werden können (Crawlbarkeit).

Allerdings bildet die On-Page-Optimierung nur einen eher kleinen Teil von 10-20% der Optimierungsmöglichkeiten. Der deutlich größere und damit wichtigste Faktor ist nach wie vor, was der Rest der Welt über Ihre Seite sagt. Worum geht es bei Ihrer Seite? Die Stimme der anderen über Ihre Seite wird mit Links abstrahiert, die auf Ihre Seite zeigen (Inbound-Links, Backlinks).

Man kann sagen, dass jeder Backlink auf Ihre Seite eine Empfehlung für Sie ist. Dabei ist auf die Qualität der linkgebenden Seite zu achten (Gewichtung der „Empfehlung“) sowie auf den Linktext mit dem Sie verlinkt werden. Dieser sagt nämlich aus, was auf der Zielseite zu finden sein wird und enthält idealerweise eines der Keywords, welches Sie auf der Zielseite forcieren. Solch eine positive Stimme steigert die Relevanz und somit Ihre Position im Ranking.

Im Eigentlichen sind das bereits die Faktoren, die die Position im Ranking (für die jeweiligen Keywords) diktieren.
...
In Summe sind das die Punkte, die Top-Rankings von denen unterscheidet, die unter ferner liefen auftauchen. Wenn man jetzt bedenkt, dass die Top-Rankings auch den Top-Traffic abbekommen und mehr Besucher ein besseres Geschäft bedeutet, ist die Optimierung der eigene Position bei Google und Co. die kosteneffizienteste Variante, mehr Umsatz im Online-Geschäft zu erzielen. Solche Verbesserungen müssen natürlich wachsen und das braucht viel Zeit. Man landet nicht von heute auf morgen auf Platz 1 der Google-Suche, ganz gleich, wie viel man investiert. Wer etwas anderes behauptet, hat unrecht oder optimiert für unnütze Keywords.
