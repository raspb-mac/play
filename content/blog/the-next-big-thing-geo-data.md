---
title: "The next big thing Geo data?!"
slug: "the-next-big-thing-geo-data"
category: "Big Data"
date: "24. Juni 2015"
isoDate: "2015-06-01"
author: "STRATECO"
readMinutes: "3"
image: "/uploads/the-next-big-thing-geo-data.png"
teaser: "Es ist kaum vorzustellen, wie viele Informationen das Internet bereit hält und wie viele Daten jede Sekunde neu dazu kommen. „The Internet in Real-Time“ gibt eine grobe Übersicht und lässt einen…"
---

Es ist kaum vorzustellen, wie viele Informationen das Internet bereit hält und wie viele Daten jede Sekunde neu dazu kommen. [„The Internet in Real-Time“](http://pennystocks.la/internet-in-real-time/) gibt eine grobe Übersicht und lässt einen staunen.
...
Zeigt weltweit die Bewegung von öffentlichen Verkehrsmitteln an. Live-Daten werden genutzt, wo sie vorhanden sind, ansonsten bedient man sich der statischen Fahrpläne. Wie das genau funktioniert kann man [hier nachlesen](http://geops.de/blog/worldwide-travic).
...
Hier ist der Name Programm und wieder geht es um Twitter. EmojiTracker stellt in Echtzeit dar, welche [Emojis](https://de.wikipedia.org/wiki/Emoji) gerade getwittert werden.
...
### > [AIS Marine Traffic](http://www.marinetraffic.com/de/)
...
### > [Global Trend Tracker](http://neomam.com/interactive/trendmap/)
...
Auch ganz toll auf einer Weltkugel visualisiert, präsentiert Kaspersky weltweite Cyberangriffe. Neben Kaspersky hat auch [FireEye]((https://www.fireeye.com/cyber-map/threat-map.html) oder [Norse](http://map.ipviking.com/) eine sog. Threat Map auf der Homepage. Welche Visualisierung gefällt euch am besten?

### > [OCEARCH.ORG](http://www.ocearch.org/)
...
### > [Whatsthere](http://www.whatsthere.co/)
...
### > [Synchronicity](http://michellechandra.github.io/synchronicity.html)
...
Für die Geschäftswelt ist es möglicherweise viel interessanter die Kundendaten geordnet in Zusammenhang zu bringen, um daraus Maßnahmen ableiten zu können. Hier geht es weniger darum, von wo aus der Kunde seine Bestellung ausgeführt hat, sondern vielmehr darum, was er über Ihr Unternehmen und Ihre Produkte denkt, welche Nutzererfahrung er im Laufe seiner Customer Journey mit Ihrer Webseite/Shop/Anwendung gesammelt hat und wie man seine Wahrnehmung verbessern kann. Wir helfen Ihnen, mit [STRATECO Customer Experience Analytics](http://strateco.de/Themen/Customer-Experience-Analytics), Kundenerfahrungen zu messen, systematisch zu analysieren und daraus Strategien zur Optimierung abzuleiten.
